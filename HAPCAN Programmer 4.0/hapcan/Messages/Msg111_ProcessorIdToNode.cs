namespace Hapcan.Programmer.Hapcan.Messages
{
    class Msg111_ProcessorIdToNode
    {
        ...
        {
            _frame = new HapcanFrame(new byte[] { 0x11, 0x10, nodeTx, groupTx, 0xFF, 0xFF, nodeRx, groupRx, 0xFF, 0xFF, 0xFF, 0xFF }, false);
        }
        ...
        public string GetDescription()
        {
            ...
            {
                return string.Format("SYSTEM - Processor ID request to node ({0},{1})", _frame.Data[7], _frame.Data[8]);
            }
            else
            {
