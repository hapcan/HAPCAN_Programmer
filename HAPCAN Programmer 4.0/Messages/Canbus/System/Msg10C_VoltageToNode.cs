...
class Msg10C_VoltageToNode
{
    ...
    {
        _frame = new HapcanFrame(new byte[] { 0x10, 0xC0, nodeTx, groupTx, 0xFF, 0xFF, nodeRx, groupRx, 0xFF, 0xFF, 0xFF, 0xFF }, HapcanFrame.FrameSource.PcToCanbus);
    }
    ...
    public string GetDescription()
    {
        ...
        {
            return string.Format("SYSTEM - Voltage request to node ({0},{1})", _frame.Data[6], _frame.Data[7]);
        }
        else
        {
